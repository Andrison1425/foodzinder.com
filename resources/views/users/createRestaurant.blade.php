...
@endif
    ...
    <h1>Solicitar registro de restaurante</h1>
    <form id="msform" class="container bg-white py-3 float-left mb-3" method="POST" action="{{ route('users.restaurantStore') }}" enctype="multipart/form-data">
    @csrf
    <!-- progressbar -->
    <ul id="progressbar">
        <div class="scroll">
